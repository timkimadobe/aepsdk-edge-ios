...
unit-test-ios:
	...
	xcodebuild test -workspace $(PROJECT_NAME).xcworkspace -scheme "UnitTests" -destination "platform=iOS Simulator,name=iPhone 16" -derivedDataPath build/out -enableCodeCoverage YES ADB_SKIP_LINT=YES
